...
import { ILoan, IPayments, LoanTypeCondition } from '../../client-model/client.model';
...
export class AddPaymentComponent {
  ...
  submitPay() {
      ...
      this.clientService.createPayToLoan(this.clientId, this.loanId, this.newPay).subscribe({
        next: (pay) => {
  ...
  ngOnInit(): void {
    ...
    if (this.loanId && this.clientId) {
      this.clientService.fetchLoanById(this.clientId, this.loanId).subscribe((loan: ILoan) => {
