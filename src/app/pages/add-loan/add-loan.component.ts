...
import { IClient, ILoan, LoanStatus, LoanTypeCondition, LoanTypeName } from '../../client-model/client.model';
...
export class AddLoanComponent {
    ...
    loanTypeLimits: { [key: string]: { maxAmount: number; maxTermMonths: number } }  = {
        ...
        [LoanTypeName.GovernmentBusiness]: { maxAmount: 1000000, maxTermMonths: 84 }, 
    ...
    submitLoan() {
        ...
        if (!this.newLoan.loanType.loanTypeName || !this.newLoan.amount || !this.newLoan.loanType.conditions || !this.newLoan.loanType.term) {
        ...
        this.newLoan.loanType.interestRate = this.loanCalculateService.defineInterestRate(this.newLoan.loanType.loanTypeName);
        this.newLoan.payable = this.loanCalculateService.calculateTotalSum(this.newLoan.loanType.conditions, this.newLoan.amount, this.newLoan.loanType.interestRate, this.newLoan.loanType.term);
        this.newLoan.totalLoan = this.newLoan.payable;


        console.log("Loan data ready to submit:", this.newLoan);
