...
import { LoanTypeName, LoanTypeCondition } from '../../client-model/client.model';
...
export class HomeComponent {
  ...
  calculateLoan() {
    ...
    console.log("Limits Max Amount:", limits.maxAmount);
    ...
    this.rateloan = this.loanCalculateService.defineInterestRate(this.selectedType);
    this.monthTotal = this.loanCalculateService.calculateTotalSum(
      LoanTypeCondition.Mounth, this.selectedAmount, this.rateloan, this.selectedTerm
    );
    ...
    this.oneTotal = this.loanCalculateService.calculateTotalSum(
      LoanTypeCondition.One, this.selectedAmount, this.rateloan, this.selectedTerm
    );
  }
}
